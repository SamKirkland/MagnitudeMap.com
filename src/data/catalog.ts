...
const CATALOG_SEED: CatalogSeed[] = [
  {
    ...
    shape: 'person',
    color: '#c4a484',
    blurb: 'Ready Player Me male avatar (~1.75 m).',
    model: {
  ...
  },
  {
    ...
    shape: 'person',
    color: '#c4a484',
    blurb: 'Ready Player Me female avatar (~1.65 m).',
    model: {
  ...
  },
  {
    ...
    shape: 'person',
    color: '#8fbc8f',
    blurb: 'The Perfect Steve (~1.8 m). Blender3D CC-BY on Sketchfab; rigged, and walks while selected.',
    playClips: true,
    model: {
  ...
  },
  {
    ...
    shape: 'box',
    color: '#e3c14a',
    blurb: 'The unofficial internet unit of scale. A Cavendish banana (~180 mm long).',
    model: {
  ...
  },
  {
    ...
    color: '#8a93a5',
    blurb:
      'Leonardo da Vinci ornithopter, drawn around 1490 and never built (~11 m wingspan).',
    model: {
      path: 'models/da-vinci-ornithopter/model.glb',
      scaleAxis: 'width',
      yawDegrees: 90,
    },
  },
  {
    ...
    color: '#c9b892',
    blurb:
      'The 1903 Wright Flyer, first powered aeroplane (12.29 m span, 6.43 m long).',
    model: {
      path: 'models/wright-flyer/model.glb',
      scaleAxis: 'width',
      yawDegrees: 0,
    },
  },
  {
    ...
    color: '#b9bfc6',
    blurb:
      'Airship LZ 129 Hindenburg (245 m long), the largest aircraft ever flown.',
    model: {
      path: 'models/hindenburg/model.glb',
      scaleAxis: 'length',
      yawDegrees: 180,
    },
  },
  ...
  },
  {
    ...
    shape: 'box',
    color: '#cbd5e1',
    blurb: 'Airbus A380-800 double-deck airliner (~72.7 m long).',
    model: {
      path: 'models/a380/model.glb',
      scaleAxis: 'length',
      yawDegrees: 0,
    },
  },
  ...
  },
  {
    ...
    shape: 'box',
    color: '#6b7280',
    blurb: 'C-5 Galaxy (~75 m long).',
    model: {
      path: 'models/c5/model.glb',
      scaleAxis: 'length',
      // Native nose is +Z. 180° points at the plaque (-Z).
      yawDegrees: 180,
    },
  ...
  },
  {
    ...
    shape: 'box',
    color: '#3b4038',
    blurb: 'MH-53J Pave Low III special-operations helicopter (~30.2 m long).',
    model: {
  ...
  },
  {
    ...
    shape: 'box',
    color: '#2f3a44',
    blurb: 'Sikorsky S-97 Raider coaxial compound demonstrator (~11 m long).',
    model: {
      path: 'models/s97/model.glb',
      scaleAxis: 'length',
      yawDegrees: 270,
    },
  },
  ...
  },
  {
    ...
    color: '#6f7a63',
    blurb:
      'Fieseler Fi 103 / V-1, the first cruise missile (8.32 m long, 5.37 m span).',
    model: {
      path: 'models/v1-flying-bomb/model.glb',
      scaleAxis: 'length',
      yawDegrees: 0,
    },
  },
  {
    ...
    color: '#e2e2e0',
    blurb:
      'Aggregat 4 / V-2, the first object to reach space (14.03 m tall).',
    model: {
      path: 'models/v2-rocket/model.glb',
      scaleAxis: 'height',
      yawDegrees: 0,
    },
  },
  ...
  },
  {
    ...
    color: '#f59e0b',
    blurb:
      'Soyuz launch vehicle in crewed configuration (~49.5 m), escape tower and all four boosters.',
    model: {
      path: 'models/soyuz-rocket/model.glb',
      scaleAxis: 'height',
    },
  },
  {
  ...
  },
  {
    ...
    color: '#b08d57',
    blurb:
      'Apollo Lunar Module, the only crewed craft to land on another world (7.04 m tall).',
    model: {
      path: 'models/apollo-lm/model.glb',
      scaleAxis: 'height',
      yawDegrees: 45,
    },
  },
  {
    ...
    color: '#c8ccd2',
    blurb:
      'NASA Hubble Space Telescope (13.2 m long), sized to fit a shuttle payload bay.',
    model: {
      path: 'models/hubble/model.glb',
      scaleAxis: 'length',
      pitchDegrees: 90,
      yawDegrees: 180,
    },
  },
  {
    ...
    color: '#c9a227',
    blurb:
      'James Webb Space Telescope, deployed — a 21.2 m sunshield the size of a tennis court.',
    model: {
      path: 'models/jwst/model.glb',
      scaleAxis: 'length',
      yawDegrees: 0,
    },
  },
  {
    ...
    color: '#aeb6c2',
    blurb:
      'NASA Nancy Grace Roman Space Telescope (12.7 m long), a 2.4 m mirror with a survey-wide field.',
    model: {
      path: 'models/roman-telescope/model.glb',
      scaleAxis: 'length',
      yawDegrees: 270,
    },
  },
...
const PRESET_SEED: ComparisonPreset[] = [
  ...
  },
  {
    id: 'bombers',
    name: 'Bombers',
    description: 'B-29 and B-52 through the stealth bombers.',
    tags: [
      'bombers',
      'stealth',
      'aircraft',
  ...
  },
  {
    id: 'airliners',
    name: 'Airliners',
    description: 'A320 and 737 up to Concorde, Air Force One, and the A380.',
    tags: [
      'airliners',
      'planes',
      'boeing',
  ...
  },
  {
    id: 'helicopters',
    name: 'Helicopters',
    description: 'S-97 Raider through the Mi-26, the heaviest ever built.',
    tags: [
      'helicopters',
      'rotary',
      'apache',
  ...
  },
  {
    ...
    description: 'A banana for scale, a phone, a bus, a shipping container.',
    tags: [
      'everyday',
      'household',
      'banana',
  ...
  {
    id: 'airlift',
    name: 'Military airlift',
    description: 'What it takes to fly a tank: C-17, C-5, and the Skylord.',
    tags: [
      'airlift',
      'transport',
      'cargo',
  ...
  },
  {
    id: 'warbirds',
    name: 'World War II',
    description: 'Spitfire, Sherman, B-29, and the bombs it carried.',
    tags: [
      'ww2',
      'wwii',
      'world war 2',
  ...
  },
  {
    id: 'supersonic',
    name: 'Supersonic',
    description: 'Concorde and the SR-71 against the jets that still go fast.',
    tags: [
      'supersonic',
      'mach',
      'fast',
  ...
  },
  {
    ...
    description: 'Hubble, Roman, and the James Webb sunshield.',
    tags: [
      'telescopes',
      'observatory',
      'space',
  ...
  },
  {
    id: 'early-flight',
    name: 'Early flight',
    description: "Da Vinci's ornithopter through the Hindenburg.",
    tags: [
      'early flight',
      'aviation',
      'history',
